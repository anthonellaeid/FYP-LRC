            ...
            <table id='form4'>
                <tr>
                    <td>
                        ...
                        <label><strong>Date: <span id='today'></span></strong></label>&emsp;&emsp;&emsp;&emsp;&emsp;
                        <label><strong>Time: <span id='currentTime'></span></strong></label><br>
                        <label><strong>Shift: <span id='shift'></span></strong></label><br>
                        ...
                        <label><strong>Ambulance:</strong></label>
                            ...
                            <label><strong>Initial mileage : </strong></label><input type="number" id="initial_mileage" name='initial_mileage' placeholder='initial mileage' ><br>
                            <label><strong>Final mileage :   </strong></label><input type="number" id='final_mileage' name='final_mileage' placeholder='final mileage' >
                            <br>
                        ...
                        <div class="btn-box">
                            ...
                            <button type='submit' class='nextbtn' onclick="submitButtonClick(event)">Save</button>   
                        </div>
                    </td>
                </tr>
            <!-- //itsyBitsySpider-----> 
          <div class="Bitsy">  <button class='Cancelbtn'style="background-color:black; color:white;  float:right; " formaction="CancelControlPCR.php" name="CancelMission" id="CancelMission">Cancel</button> 
