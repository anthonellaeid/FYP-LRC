            ...
            <table id='form4'>
                <tr>
                    <td>
                        ...
                        <label><strong><br>Start: <span ><input id='currentHour' name="currentHour" type='time' value="<?php echo date("H:i:s",strtotime($startDate));?>" min=""></span></strong></label>
                            <?php
                        ...
                        <br><label><strong>Shift: <span><input readonly value="<?php echo $rMission['mission_shift_code'];?>" id='shift' name="shift"></span></strong></label><br>
                            ...
                            <select name='emt' id='emt'>
                                ...
                                <?php 
                                    while($o=mysqli_fetch_array($result6)){
                                        ...
                                        if($ResrescuerEMT >0){
                                            while($ResrescuerEMT1=mysqli_fetch_assoc($ResultGetMissionRescuersEMT)){
