...
if(!isset($_SESSION["login"]))
  ...
  require_once("ReportsRescuerMonthly_Modal.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
.Configure{background-image: url('grey.jpg'); 
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <img src="pics/logo.webp" width="20px" >&nbsp;
    ...
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="ReportsRescuerMonthly.php" role="button" style="color:red;" aria-haspopup="true" aria-expanded="false">Rescuer Report Monthly</a>
...
<div class="container-fluid" style="margin-left:7%;width:85%;"  >
    ...
    <form method="POST" action="ReportsRescuerMonthly.php">
    ...
    <div class="Configure">
      ...
      <div class="col">
      <label> Month</label>
      <select class="custom-select my-1 mr-sm-2" onchange="val()"id="SelectMonth" name="SelectMonth" style="width:150px;">
      <option> </option>
      <?php 
        require('DBconnection.inc.php');

        while($resM=mysqli_fetch_assoc($resultMonth)) {  
        echo"<option  value='".$resM['monthNb']."' ";
        // if($resM['monthM']==date('M')){
        // echo" selected";}
        echo "> ".$resM['monthM']."</option>";
        }
        ?>
      </select>	
      </div>
      ...
      <button class="btn btn-second " id="Clearbtn" > Clear</button> 
        <button class="btn btn-second" id="Submitbtn" name="Submitbtn"  style="background-color:red;color:#fff; "> Submit</button>
         <div class="col" style="margin-left:30%; margin-top:20%;">
          <label > Full Version</label>
          <input type="checkbox" value="checked" id="CheckFullVersion" name="CheckFullVersion">
        </div>
      </div>
      </div>
    </div>
...
if($w>0){
  ...
  echo "<div ><center><p id='text1' style='color:grey;'>List of Completed Missions Done By 
        ...
        </strong>  on <strong>".$qq['monthM']."</strong> </p> </center></div><br>";

  

// echo'
// <div><center><p id=t2> </p></center> </div>
// <script>
// function val() {var str;
//   var d = document.getElementById("SelectMonth");
//   if(d!=null){str=d.value;
//     const date = new Date();
//     date.setMonth(str - 1);
//    var in1= document.getElementById("t2");
//    var inn;
//    if(in1!=null){
// inn=in1.innerHTML+=" On "+date.toLocaleString("en-US", {
//     month: "long",
//   });
//    }else{
//     alert("text1 doesn t exist");
//    }
//     }  else{str=null;}
//   alert(str);
// }
