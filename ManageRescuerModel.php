<?php
    ...
    function updateRescuer($nickname,$firstname,$lastname,$dateofbirth,$phonenb,$datejoin,$dateleft,$function,$gender){
        ...
        $query="UPDATE `rescuer` 
                SET `rescuer_firstName`='".$firstname."',`rescuer_lastName`='".$lastname."',`rescuer_dateOfBirth`='".$dateofbirth."',`rescuer_gender`='".$gender."',`rescuer_phoneNb`='".$phonenb."',`rescuerDate_join`='".$datejoin."',`rescuerDate_left`='".$dateleft."',`rescuer_function`='".$function."'
    ...
    function updateRescuer1($nickname,$firstname,$lastname,$dateofbirth,$phonenb,$datejoin,$function,$gender){
        ...
        // $query="UPDATE `rescuer` SET `rescuer_firstName`='".$fname."',`rescuer_lastName`='".$lname."',`rescuer_dateOfBirth`='".$dateofbirth."',`rescuer_phoneNb`='".$phonenb."',`rescuerDate_join`='".$datejoin."',`rescuerDate_left`='".$dateleft."' WHERE `rescuer_nickname`= '".$nickname."'";
        $query="UPDATE `rescuer` 
                SET `rescuer_firstName`='".$firstname."',`rescuer_lastName`='".$lastname."',`rescuer_dateOfBirth`='".$dateofbirth."',`rescuer_gender`='".$gender."',`rescuer_phoneNb`='".$phonenb."',`rescuerDate_join`='".$datejoin."',`rescuerDate_left`=NULL,`rescuer_function`='".$function."'
                WHERE `rescuer_nickname`= '".$nickname."'";
        $res=mysqli_query($conn,$query);
        mysqli_close($conn);
        return $res;
...
function addRescuer($nickname,$firstname,$lastname,$dateofbirth,$phonenb,$datejoin,$gender){
    require("DBconnection.inc.php");
    $query="INSERT INTO `rescuer`(`rescuer_nickname`, `rescuer_firstName`, `rescuer_lastName`, `rescuer_dateOfBirth`, `rescuer_phoneNb`, `rescuerDate_join`,
        `rescuer_function`,`rescuer_gender`) 
        VALUES ('".$nickname."','".$firstname."','".$lastname."','".$dateofbirth."','".$phonenb."','".$datejoin."',3,'".$gender."')";
    $res=mysqli_query($conn,$query);
    mysqli_close($conn);
    return $res;
}
