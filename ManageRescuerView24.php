...
<form action="ManageRescuerController24.php" method="POST">
    ...
    <button id='addrescuerbtn' type="button" onclick='plusItem()' class='btnadd'>Add Rescuer</button><br>
    

    
    <a class="designA" style="margin-left:70%;" href="Settings.php">Settings</a>
    
    <a href="logout.php" style="margin-left:90%;"> 
        <img src="log-out-icon-27.jpg" alt="logout_icon" width="60px" height="60px">
    </a>
