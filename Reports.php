...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
  	<img src="pics/logo.webp" width="80px" >&nbsp;
	...
	<ul class="navbar-nav my-auto my-2 my-lg-0"style="margin-left:80%;">
		<li class="nav-item active">
			<!-- <a class="nav-link" href="Settings.php">Settings <span class="sr-only">(current)</span></a> -->
			<a class="nav-link designA" href="Settings.php">Settings</a>
		</li>
		<li class="nav-item active">
			<!-- <a class="nav-link" href="logout.php">Logout <span class="sr-only">(current)</span></a> -->
			<a class="nav-link designA" href="logout.php">
				Logout <img src="log-out-icon-27.jpg" alt="logout_icon" width="30px" height="30px">
			</a>
		</li>
	</ul>
...
<div class="container-fluid" >
	...
	<h1><img src="report-clear-icon-free-vector.jpg" alt="report..." width="300px" height="300px">Reports</h1>
    ...
    <div class="row" style="width:auto; margin:auto;">
		...
		<div class="col">
			<div class="card border-danger  mb-3" style="max-width: 540px; ">
				<div class="row g-0" style="height:300px;"><!--Image -->
					<div class="col-md-4">
				...
				<div class="col-md-8" style="height:250px;"><!--Card Information -->
					<div class="card-body">
					<h4 class="card-title">
						<a class="nav-link toreport" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Rescuer</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="ReportsRescuerAnnual.php">Annual </a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="ReportsRescuerMonthly.php">Monthly</a>
		...
		<div class="col">
			<div class="card border-danger mb-3" style="max-width: 540px;">
				...
				<!-- <div class="col-md-8" style="height:250px;"> -->
					...
					<a href="ambulanceReportView.php">
						<h5 class="nav-link toreport">Ambulance</h5>
					</a>
					<ul class="list-group list-group-flush"style="font-size:15px;">
					<?php 
