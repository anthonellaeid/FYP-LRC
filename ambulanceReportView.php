...
<body>
    ...
    <div >
        <a class="designA" href="Settings.php">Settings</a>
        <a class="designA" href="logout.php">Logout <img src="log-out-icon-27.jpg" alt="logout_icon" width="30px" height="30px"></a>
    </div>
