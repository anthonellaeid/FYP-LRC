...
.bgimg {
  background-image: linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('pics/what-it-costs.jpg');
  min-height: 100%;
...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
  ...
  <div class="w3-display-middle">
    ...
    <p class="w3-large w3-center"> <button id="newPCr"class="shadow" style="font-size:25px;">New PCR</button></p>
    <p class="w3-large w3-center"><button id="myButton" class="shadow"  style="font-size:25px;">Today's Missions</button></p>
    <p class="w3-large w3-center"> <button id="Logout" class="shadow"  style="font-size:25px;" >Log Out</button></p>
