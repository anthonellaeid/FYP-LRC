...
.text-header{color:black; font-size:10px;}
...
<body>
		...
		<div class="content">
			...
			<div class="subheader">
				<div>
					<p>&emsp;&emsp; Welcome Administrator ! <a href="logout.php" class="subhead"> <i style="font-size:24px;" class="fa"> <span style="font-family:sans-serif;font-size:18px;"> Logout</span> &#xf08b;</i></a></p>
